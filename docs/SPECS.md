...
- **Lecteur** — persistant : au sens du contenu (ne change que sur un clic d'épisode explicite, sommaire ou résultat de recherche, jamais par la seule navigation) et au sens visuel (collé en haut de la fenêtre en scrollant le sommaire, issue #54 — réduit en mini-lecteur sous 640px pour ne pas manger tout l'écran). L'onglet du livre en cours de lecture porte toujours une pastille « en direct », que cet onglet soit affiché ou non (on peut parcourir un livre pendant qu'un autre joue).
